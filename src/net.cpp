    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            ...
            pszGet = "GET / HTTP/1.1\r\n"
                     ...
                     "User-Agent: altcoinreservesystem\r\n"
                     "Connection: close\r\n"
                     "\r\n";
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "altcoinreservesystem " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. altcoinreservesystem is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("altcoinreservesystem-start");
