...
unsigned int nTargetSpacing = 1 * 60; // Retargeting 60 seconds
...
int nCoinbaseMaturity = 20; // Mature 20 Blocks
...
const string strMessageMagic = "altcoinreservesystem Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20) // ALT RESERVE SYSTEM CENTRAL BANK
    {
...
// altcoinreservesystem: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "altcoinreservesystem", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Revolutionary Altcoin reserve system";
        CTransaction txNew;
        txNew.nTime = 1447192070;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x42547581110b128bbecd9cb9272e5824404a42ba225b2620df23427f3cdea376"));
        block.print();
